...
public class ColumnsRecord extends UpdatableRecordImpl<ColumnsRecord> implements Record7<String, String, String, Boolean, Short, String, String> {

    private static final long serialVersionUID = 1335775571;
