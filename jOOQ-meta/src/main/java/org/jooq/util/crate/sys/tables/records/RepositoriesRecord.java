...
public class RepositoriesRecord extends TableRecordImpl<RepositoriesRecord> implements Record3<String, Object, String> {

    private static final long serialVersionUID = -1854949256;
