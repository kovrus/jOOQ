...
public class SnapshotsRecord extends TableRecordImpl<SnapshotsRecord> implements Record7<String, Timestamp, String, String, Timestamp, String, String> {

    private static final long serialVersionUID = 846719381;
