...
public class Tables extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = -1493029316;
     ...
     */
    public final TableField<Record, String> BLOBS_PATH = createField("blobs_path", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.tables.clustered_by</code>.
     */
    public final TableField<Record, String> CLUSTERED_BY = createField("clustered_by", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>information_schema.tables.column_policy</code>.
     */
    public final TableField<Record, String> COLUMN_POLICY = createField("column_policy", org.jooq.impl.SQLDataType.VARCHAR, this, "");
     ...
     */
    public final TableField<Record, String[]> PARTITIONED_BY = createField("partitioned_by", org.jooq.impl.SQLDataType.VARCHAR.getArrayDataType(), this, "");
     ...
     */
    public final TableField<Record, Long> SETTINGS_5b_27GATEWAY_27_5d_5b_27LOCAL_27_5d_5b_27SYNC_27_5d = createField("settings['gateway']['local']['sync']", org.jooq.impl.SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<Record, Long> SETTINGS_5b_27REFRESH_INTERVAL_27_5d = createField("settings['refresh_interval']", org.jooq.impl.SQLDataType.BIGINT, this, "");
