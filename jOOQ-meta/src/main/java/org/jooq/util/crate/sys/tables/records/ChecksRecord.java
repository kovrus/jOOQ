...
public class ChecksRecord extends UpdatableRecordImpl<ChecksRecord> implements Record4<String, Integer, Boolean, Integer> {

    private static final long serialVersionUID = -1842960095;
