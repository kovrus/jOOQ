...
import org.jooq.util.crate.sys.tables.records.JobsRecord;
...
public class Jobs extends TableImpl<JobsRecord> {
    ...
    private static final long serialVersionUID = -877506745;
     ...
     */
    public final TableField<JobsRecord, String> ID = createField("id", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>sys.jobs.started</code>.
     */
    public final TableField<JobsRecord, Timestamp> STARTED = createField("started", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>sys.jobs.stmt</code>.
     */
    public final TableField<JobsRecord, String> STMT = createField("stmt", org.jooq.impl.SQLDataType.VARCHAR, this, "");
    ...
    private Jobs(String alias, Table<JobsRecord> aliased) {
        this(alias, aliased, null);
    }

    private Jobs(String alias, Table<JobsRecord> aliased, Field<?>[] parameters) {
    ...
    public List<UniqueKey<JobsRecord>> getKeys() {
        return Arrays.<UniqueKey<JobsRecord>>asList(Keys.PRIMARY_KEY);
    }
